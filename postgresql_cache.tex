...
При использовании кэширования, которому нет дела до транзакций СУБД, <<снимки>> БД могут быть с неверными данными.
...
СУБД будет заниматься своей непосредственной целью~--- хранением и предоставлением целостности данных.
