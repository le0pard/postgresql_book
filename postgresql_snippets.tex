...
\lstinputlisting[label=lst:snippets1,title=snippets/biggest\_relations.sql]{codes/snippets/biggest_relations.sql}
...
\lstinputlisting[label=lst:snippets3,title=snippets/biggest\_tables.sql]{codes/snippets/biggest_tables.sql}
...
\lstinputlisting[label=lst:snippets5,title=snippets/count\_estimate.sql]{codes/snippets/count_estimate.sql}
...
\lstinputlisting[label=lst:snippets6,title=snippets/default\_value.sql]{codes/snippets/default_value.sql}
...
\lstinputlisting[label=lst:snippets8,title=snippets/random\_from\_range.sql]{codes/snippets/random_from_range.sql}
...
\lstinputlisting[label=lst:snippets10,title=snippets/luhn\_algorithm.sql]{codes/snippets/luhn_algorithm.sql}
...
\lstinputlisting[label=lst:snippets12,title=snippets/order\_like\_in.sql]{codes/snippets/order_like_in.sql}
...
\lstinputlisting[label=lst:snippets13,title=snippets/quine.sql]{codes/snippets/quine.sql}
...
\lstinputlisting[label=lst:snippets14,title=snippets/speed\_like.sql]{codes/snippets/speed_like.sql}
...
\lstinputlisting[label=lst:snippets15,title=snippets/duplicate\_indexes.sql]{codes/snippets/duplicate_indexes.sql}

\subsection{Размер и статистика использования индексов}

\lstinputlisting[label=lst:snippets16,title=snippets/indexes\_statustic.sql]{codes/snippets/indexes_statustic.sql}
...
\lstinputlisting[label=lst:snippets17,title=snippets/bloating.sql]{codes/snippets/bloating.sql}
