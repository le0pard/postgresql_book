...
Подготовленный файл \lstinline!replicate_def_pgbench.sql! находится в каталоге sample. Команда psql запускается с указанием пути к исходному коду, определяющему правила репликации, как показано ниже:
