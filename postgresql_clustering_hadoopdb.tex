...
Теперь создадим базу данных, таблицу и загрузим наши данные в нее:
\begin{verbatim}
...
Наш эксперимент показывает, что HadoopDB может приблизиться в отношении производительности к параллельным системам 
