...
\begin{lstlisting}[label=lst:haddop18,caption=Тестирование]
...
\begin{lstlisting}[language=Java,label=lst:haddop19,caption=Тестирование]
use strict;
use warnings;
...
\begin{lstlisting}[label=lst:haddop20,caption=Тестирование]
